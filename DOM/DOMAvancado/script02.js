...
//função ára sugestão de texto em campos de busca ->
...
let lista = document.createElement("ul"); //lista nao ordenada
lista.id = "sugestoes";
lista.style.listStyle = "none"; //remove a caract de lista * antes do texto
